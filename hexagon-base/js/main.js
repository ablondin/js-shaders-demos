...
Scene.prototype.drawZone = function (angle, color) {
    ...
    this.graphics.lineTo(12 * 50 * Math.cos(angle),
                         12 * 50 * Math.sin(angle));
    this.graphics.lineTo(12 * 50 * Math.cos(angle + Math.PI / 3),
                         12 * 50 * Math.sin(angle + Math.PI / 3));
    this.graphics.lineTo(50 * Math.cos(angle + Math.PI / 3),
                         50 * Math.sin(angle + Math.PI / 3));
...
Scene.prototype.update = function () {
    ...
    this.graphics.drawRegularPolygon(0, 0, 6, 50, 0);
};
...
function create() {
    scene = new Scene(game.add.graphics());
    scene.update();
}
